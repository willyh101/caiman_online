...
# from ...wscomm import Alert
# from ...utils import cleanup
# from ...workers import run_seeded_pipeline
...
#             elif data == 'wtf':
#                 Alert('BAD ERROR IN CAIMAN_MAIN (self.everything_is_ok == False)', 'error')
#                 print('quitting...')
#                 self.loop.stop()
...
#                 print(f'nplanes set to: {self.expt.planes}')
...
#         # TODO but this would mean it would need to be running in the event loop and 2 co-routines would
#         # need to be running...
#         while True:
#             data_to_process = await self.q.get()
#             task =self.loop.run_in_executor(None, data_to_process)
#             await task
#             self.q.task_done()
...
#             fun = lambda x: run_seeded_pipeline(*args, *kwargs)
#             self.q.put_nowait(fun)
...
#             except:
#                 Alert('Not able to clean everything up bc a file was in use probably.', 'warn')
